...
namespace viabpr2
{
    ...
    public class viabpr2
    {
        ...
        public viabpr2() {
            ...
            var parametersRegexPattern = $"^/devices/(?<{partitionKeyName}>[^/]+)";
            if (hasSortKey) {
